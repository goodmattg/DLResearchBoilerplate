...
class GCN_Keras(Model):
    def __init__(self, input_dim, output_dim, supports, num_features_nonzero, **kwargs):
        inputs = Input(shape=input_dim)
        x = GraphConvolutionKeras(
            input_dim=input_dim,
            output_dim=32,  # TODO: I AM HARDCODED INSTEAD OF hidden1. change me to configurable
            supports=supports,
        ...
        x = GraphConvolutionKeras(
            input_dim=32,  # TODO: I AM HARDCODED INSTEAD OF hidden1. change me to configurable
